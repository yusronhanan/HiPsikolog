      ...
      <table class="table table-bordered" id="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a type="button" class="btn btn-danger"  href="<?= site_url();?>home/deletepsy/<?= $d->psyID ?>" onClick="return confirm('Are you sure?')" ><i class="fas fa-user-times"></i></a></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
  ...
  <div class="modal fade" id="edit<?php echo $d->psyID ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="<?= site_url();?>home/editPsy">
...
<div class="modal fade" id="addpsy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form method="post" action="<?= site_url('home/addPsychologist') ?>">
