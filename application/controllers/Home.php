...
*/
      ...
      public function myappointment()
      {
        ...
        if ($this->session->userdata('logged_in') && $this->session->userdata('role') != "admin") {
            ...
            $data['data_appointment_active'] = $this->M_appointment->get_Appointment_ActivePsy($id);
            $data['data_appointment_history'] = $this->M_appointment->get_Appointment_HistoryPsy($id);
